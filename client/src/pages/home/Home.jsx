...
export default function Home() {
  ...
  useEffect(()=>{
    const fetchPosts=async()=>{ //fetchPosts is an asynchronous function that sends an HTTP GET request to the specified URL 
      const res = await axios.get("http://localhost:5000/api/posts"+search)//matlab frontend se backend ko request bhejta jisse ham databse ko access kar paate hain and other things also
