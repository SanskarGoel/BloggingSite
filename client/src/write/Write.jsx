...
export default function Write() {
  ...
  return (
    <div className="write">
        ...
        src="https://www.shutterstock.com/image-photo/panorama-beautiful-countryside-romania-sunny-260nw-1302294157.jpg" alt="" />
      <form className="writeForm" onSubmit={handleSubmit}>
        <div className="writeFormGroup">
            ...
            autoFocus={true} onChange={e=>setTitle(e.target.value)}/>{/*it will update the value of title */}
        </div>
        <div className="writeFormGroup">
